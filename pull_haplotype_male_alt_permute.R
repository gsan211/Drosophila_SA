...
for (i in (1:nrow(targ))){
  ...
  #permute all sites in vicinity
   for (i in 1:ncol(sit4)){
      sit4[,i] = sample(sit4[,i], replace=FALSE)}
  ...
  write(line,file="/plas1/george.sandler/dpgp3/Karl/permute/pi_haplotypes_male_alt_permuted.txt", append= T)
}
